...
echo "16 - TENANT_ID:" $TENANT_ID 
echo "17 - SUBSCRIPTION_ID: "$SUBSCRIPTION_ID
echo "18 - AAD_CLIENT_ID:" $AAD_CLIENT_ID
echo "19 - ACNT_SECRET:" $ACNT_SECRET
echo "20 - RG_NAME:" $RG_NAME
echo "21 - RG_LOCATION:" $RG_LOCATION
